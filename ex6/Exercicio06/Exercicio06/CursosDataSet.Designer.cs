...
namespace Exercicio06 {
    ...
    public partial class CursosDataSet : global::System.Data.DataSet {
        ...
        public partial class ProdutoDataTable : global::System.Data.TypedTableBase<ProdutoRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ProdutoRow AddProdutoRow(int id, string nome, int quantidade) {
...
namespace Exercicio06.CursosDataSetTableAdapters {
    ...
    public partial class ProdutoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Produto] WHERE (([id] = @Original_id) AND ((@IsNull_nome = 1 A" +
                "ND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_quantidade = 1 AN" +
                "D [quantidade] IS NULL) OR ([quantidade] = @Original_quantidade)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Produto] ([id], [nome], [quantidade]) VALUES (@id, @nome, @qua" +
                "ntidade);\r\nSELECT id, nome, quantidade FROM Produto WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Produto] SET [id] = @id, [nome] = @nome, [quantidade] = @quantidade WHERE (([id] = @Original_id) AND ((@IsNull_nome = 1 AND [nome] IS NULL) OR ([nome] = @Original_nome)) AND ((@IsNull_quantidade = 1 AND [quantidade] IS NULL) OR ([quantidade] = @Original_quantidade)));
SELECT id, nome, quantidade FROM Produto WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Exercicio06.Properties.Settings.Default.CursosConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, nome, quantidade FROM dbo.Produto";
        ...
        public virtual int Fill(CursosDataSet.ProdutoDataTable dataTable) {
        ...
        public virtual CursosDataSet.ProdutoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CursosDataSet.ProdutoDataTable dataTable = new CursosDataSet.ProdutoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CursosDataSet.ProdutoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_nome, global::System.Nullable<int> Original_quantidade) {
        ...
        public virtual int Insert(int id, string nome, global::System.Nullable<int> quantidade) {
        ...
        public virtual int Update(int id, string nome, global::System.Nullable<int> quantidade, int Original_id, string Original_nome, global::System.Nullable<int> Original_quantidade) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string nome, global::System.Nullable<int> quantidade, int Original_id, string Original_nome, global::System.Nullable<int> Original_quantidade) {
            return this.Update(Original_id, nome, quantidade, Original_id, Original_nome, Original_quantidade);
        }
    }
